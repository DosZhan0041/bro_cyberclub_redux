# Bro-CyberClub - Проект для компьютерного клуба BRO. Через него можно забронировать место, купив  пакеты и также у каждого клиента есть права на регистрацию и для логина! 
